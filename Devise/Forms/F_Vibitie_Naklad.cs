...
namespace Devise
{
    public partial class F_Vibitie_Naklad : Form
    {
        ...
        public void check()
        {
            ...
            PdfPCell cell = new PdfPCell(new iTextSharp.text.Phrase("Клиент", font));
            ...
            for (int i = 0; i < dataGridView2.RowCount - 1; i++)
            {
                ...
                cell = new PdfPCell(new iTextSharp.text.Phrase(dataGridView2.Rows[i].Cells[10].Value.ToString(), font));
                tb.AddCell(cell);
            }
            ...
            cell.HorizontalAlignment = 0;
            tb.AddCell(cell);
            cell = new PdfPCell(new iTextSharp.text.Phrase(dataGridView1.CurrentRow.Cells[7].Value.ToString(), font));
            cell.Border = 0;
            cell.HorizontalAlignment = 0;
            tb.AddCell(cell);
            ...
            cell.HorizontalAlignment = 0;
            tb.AddCell(cell);
            cell = new PdfPCell(new iTextSharp.text.Phrase(dataGridView1.CurrentRow.Cells[8].Value.ToString(), font));
            cell.Border = 0;
            cell.HorizontalAlignment = 0;
            tb.AddCell(cell);
            ...
            cell.HorizontalAlignment = 0;
            tb.AddCell(cell);
            cell = new PdfPCell(new iTextSharp.text.Phrase(dataGridView1.CurrentRow.Cells[9].Value.ToString(), font));
            cell.Border = 0;
            cell.HorizontalAlignment = 0;
            tb.AddCell(cell);
            doc.Add(tb);
            ...
            try
            {
                if (dataGridView1.RowCount > 1)
                {
                    if (dataGridView1.RowCount != dataGridView1.CurrentRow.Index)
                        textBox1.Text = new Summ_naklad().Summ("Sost_Naklad_Prodag", "ID_Naklad_Prodag", (int)dataGridView1.CurrentRow.Cells[0].Value).ToString();
                }
            }
            catch { }
        }
